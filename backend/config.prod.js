...
config.MONGO_URI = process.env.MONGO_URI || 'mongodb://amax:amax123456@172.17.0.1:27017/AMAXExpProd';
...
// reserved nodes
config.endpoints = [
  'http://172.17.0.1:8888',  //localhost access
...
config.customChain = process.env.CUSTOMCHAIN || 'http://172.17.0.1:8888';

// api url for history
config.historyChain = process.env.HISTORYCHAIN || 'http://172.17.0.1:8888'; //still the RPC chain
