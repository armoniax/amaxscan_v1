...
config.MONGO_URI = process.env.MONGO_URI || 'mongodb://amax:amax123456@10.88.0.1:27017/AMAXExpProd';
...
config.customChain = process.env.CUSTOMCHAIN || 'http://10.88.0.1:8888';

// api url for history
config.historyChain = process.env.HISTORYCHAIN || 'http://10.88.0.1:8888'; //still the RPC chain
