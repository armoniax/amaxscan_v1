...
config.customChain = process.env.CUSTOMCHAIN || 'http://expnode-service.amax-prod:8889';

// api url for history
config.historyChain = process.env.HISTORYCHAIN || 'http://expnode-service.amax-prod:8889'; //still the RPC chain
