...
config.endpoints = [
  // exp6
  'http://172.31.12.250:8888'  //localhost access
...
config.customChain = process.env.CUSTOMCHAIN || 'http://172.31.12.250:8888';

// api url for history
config.historyChain = process.env.HISTORYCHAIN || 'http://172.31.12.250:8888'; //still the RPC chain
