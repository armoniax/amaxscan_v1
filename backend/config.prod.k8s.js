...
// reserved nodes
config.endpoints = [
  'http://172.31.12.214:8889',  //localhost access
...
config.customChain = process.env.CUSTOMCHAIN || 'http://172.31.12.214:8889';

// api url for history
config.historyChain = process.env.HISTORYCHAIN || 'http://172.31.12.214:8889'; //still the RPC chain
