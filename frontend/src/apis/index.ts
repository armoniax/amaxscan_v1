...
export const GET_BLACKLIST = (accountName: string) => Ax.post(`/v1/get_blacklist/${accountName}`);
...
export const GET_KEY_ACCOUNTS = (pubkey: string) => Ax.get(`/v1/get_accounts_by_authorizers/${pubkey}`);
